...
public class DocumentUploader extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        session = new Session(DocumentUploader.this);
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            ...
                            if (items[item].equals("Take Photo")) {
                                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                                        && ActivityCompat.checkSelfPermission(DocumentUploader.this, Manifest.permission.CAMERA)
...
//                        });
    ...
    private void requestMultiplePermissions() {
        Dexter.withActivity(DocumentUploader.this)
                .withPermissions(
                ...
                withErrorListener(new PermissionRequestErrorListener() {
                    ...
                    public void onError(DexterError error) {
                        Toast.makeText(DocumentUploader.this, "Some Error! ", Toast.LENGTH_SHORT).show();
                    }
                })
                .onSameThread()
                .check();
        ...
        if (!(view instanceof EditText)) {
            view.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    hideSoftKeyboard(DocumentUploader.this);
                    return false;
                }
            });
        }
