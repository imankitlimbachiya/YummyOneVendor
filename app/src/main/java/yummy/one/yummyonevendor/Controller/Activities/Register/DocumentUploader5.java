...
public class DocumentUploader5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        session = new Session(DocumentUploader5.this);
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            ...
                            if (items[item].equals("Take Photo")) {
                                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                                        && ActivityCompat.checkSelfPermission(DocumentUploader5.this, Manifest.permission.CAMERA)
...
//                                Toast.makeText(DocumentUploader5.this, exception.getMessage(), Toast.LENGTH_SHORT).show();
//                            }
//                        })
...
//                        });
    ...
    private void requestMultiplePermissions() {
        Dexter.withActivity(DocumentUploader5.this)
                .withPermissions(
                ...
                withErrorListener(new PermissionRequestErrorListener() {
                    ...
                    public void onError(DexterError error) {
                        Toast.makeText(DocumentUploader5.this, "Some Error! ", Toast.LENGTH_SHORT).show();
                    }
                })
                .onSameThread()
                .check();
        ...
        if (!(view instanceof EditText)) {
            view.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    hideSoftKeyboard(DocumentUploader5.this);
                    return false;
                }
            });
        }
    ...
    private void AddBankDetailsApi(String passbookImage1,String passbookImage2,  String passbookImage3) {
      //  progressBar.setVisibility(View.VISIBLE);
        ...
        try {
            ...
            data.put("accountname", "Rohan G");
            data.put("accountnumber","12121234124");
            data.put("ifscCode", "HDFC0001231");
            data.put("branchAddress","JAYANAGAR BRANCH");
