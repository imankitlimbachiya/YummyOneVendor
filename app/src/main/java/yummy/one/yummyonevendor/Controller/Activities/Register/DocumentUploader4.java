...
public class DocumentUploader4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_document_uploader4);
        ...
        session = new Session(DocumentUploader4.this);

        imgBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DocumentUploader4.this, RegisterDetails.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        ...
        txtHeading.setText("Registeration Certificate");
        txtHeading1.setText("Registeration Certificate");
        txtApprovedHeading.setText("Registeration Certificate");
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()) {
                    try {
                        ...
                        if (documentSnapshot.contains("LICNumber")) {
                            edtDocumentNumber.setText(documentSnapshot.get("LICNumber").toString());
                            if (btnUpload.getVisibility() != View.VISIBLE) {
                                edtDocumentNumber.setEnabled(false);
                            }
                        }
                        if (documentSnapshot.contains("LICImage1")) {
                            path1 = documentSnapshot.get("LICImage1").toString();
                        ...
                        if (documentSnapshot.contains("LICImage2")) {
                            path2 = documentSnapshot.get("LICImage2").toString();
                        ...
                        if (documentSnapshot.contains("LICImage3")) {
                            path3 = documentSnapshot.get("LICImage3").toString();
                        ...
                        if (documentSnapshot.contains("LICImageComments")) {
                            if (!TextUtils.isEmpty(documentSnapshot.get("LICImageComments").toString()))
                                txtComments.setText("" + documentSnapshot.get("LICImageComments").toString());
                            else
                        ...
                        if (documentSnapshot.contains("LICImage1") && documentSnapshot.contains("LICImageApproval") && documentSnapshot.contains("LICImageComments")) {
                            if (!TextUtils.isEmpty(Objects.requireNonNull(documentSnapshot.get("LICImageApproval")).toString())) {
                                if (documentSnapshot.get("LICImageApproval").toString().equalsIgnoreCase("Pending")) {
                                    ...
                                    // Glide.with(DocumentUploader4.this).asGif().load(R.raw.document_approved).into(imgApproved);
                                    Glide.with(DocumentUploader4.this).load(R.drawable.success).into(imgApproved);

                                } else if (documentSnapshot.get("LICImageApproval").toString().equalsIgnoreCase("Rejected")) {
                                    btnUpload.setVisibility(View.VISIBLE);
                                    txtComments.setVisibility(View.VISIBLE);
                                    txtComments.setVisibility(View.VISIBLE);
                                    txtComments.setText("Rejected : " + documentSnapshot.get("LICImageComments"));
...
//                txtComments1.setVisibility(View.GONE);
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(path3)) {
                    if (TextUtils.isEmpty(path2)) {
                        ...
                        data.put("LICImage1", FieldValue.delete());
                        data.put("LICImage2", FieldValue.delete());
                        data.put("LICImage3", FieldValue.delete());
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(path1) || path1.contains(".pdf")) {
                    final CharSequence[] items = {"Take Photo", "Choose from Library",
                            "Cancel"};
                    AlertDialog.Builder builder = new AlertDialog.Builder(DocumentUploader4.this, AlertDialog.THEME_HOLO_LIGHT);
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            ...
                            if (items[item].equals("Take Photo")) {
                                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                                        && ActivityCompat.checkSelfPermission(DocumentUploader4.this, Manifest.permission.CAMERA)
        ...
        btnUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FirebaseFirestore db = FirebaseFirestore.getInstance();
                Map<String, Object> data = new HashMap<>();
                data.put("LICImageApproval", "Pending");
                data.put("LICNumber", edtDocumentNumber.getText().toString());
                db.collection("Vendor").document(session.getusername()).set(data, SetOptions.merge());
...
//                                Toast.makeText(DocumentUploader4.this, exception.getMessage(), Toast.LENGTH_SHORT).show();
//                            }
//                        })
...
//                        });
                ...
                Toast.makeText(DocumentUploader4.this, "File Path Null", Toast.LENGTH_SHORT).show();
            }
...
//                        });
    ...
    private void requestMultiplePermissions() {
        Dexter.withActivity(DocumentUploader4.this)
                .withPermissions(
                ...
                withErrorListener(new PermissionRequestErrorListener() {
                    ...
                    public void onError(DexterError error) {
                        Toast.makeText(DocumentUploader4.this, "Some Error! ", Toast.LENGTH_SHORT).show();
                    }
                })
                .onSameThread()
                .check();
        ...
        if (!(view instanceof EditText)) {
            view.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    hideSoftKeyboard(DocumentUploader4.this);
                    return false;
                }
            });
        }
