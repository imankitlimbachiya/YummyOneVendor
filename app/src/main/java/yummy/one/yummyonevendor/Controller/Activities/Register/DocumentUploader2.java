                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            ...
                            if (items[item].equals("Take Photo")) {
                                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                                        && ActivityCompat.checkSelfPermission(DocumentUploader2.this, Manifest.permission.CAMERA)
        ...
        btnUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(edtDocumentNumber.getText().toString())) {
                    edtDocumentNumber.setError("Enter GST Number");
...
//                                Toast.makeText(DocumentUploader2.this, exception.getMessage(), Toast.LENGTH_SHORT).show();
//                            }
//                        })
...
//                        });
    ...
    private void requestMultiplePermissions() {
        Dexter.withActivity(DocumentUploader2.this)
                .withPermissions(
                ...
                withErrorListener(new PermissionRequestErrorListener() {
                    ...
                    public void onError(DexterError error) {
                        Toast.makeText(DocumentUploader2.this, "Some Error! ", Toast.LENGTH_SHORT).show();
                    }
                })
                .onSameThread()
                .check();
        ...
        if (!(view instanceof EditText)) {
            view.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    hideSoftKeyboard(DocumentUploader2.this);
                    return false;
                }
            });
        }
