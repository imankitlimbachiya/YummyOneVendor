package yummy.one.yummyonevendor.Functionality;
...
public class Session {
    ...
    public void setvendorname(String usename)
    {
        prefs.edit().putString("vendorname", usename).commit();
    }

    public String getvendorname() {
        String usename = prefs.getString("vendorname","");
        return usename;
    }
    ...
    public void setflat(String username) {
        prefs.edit().putString("flat", username).commit();
    }

    public String getflat() {
        String username = prefs.getString("flat", "");
        return username;
    }

    public void setlandmark(String username) {
        prefs.edit().putString("landmark", username).commit();
    }

    public String getlandmark() {
        String username = prefs.getString("landmark", "");
        return username;
    }

    public void setstate(String username) {
        prefs.edit().putString("state", username).commit();
    }

    public String getstate() {
        String username = prefs.getString("state", "");
        return username;
    }
    ...
    public void setdocument(String username) {
        prefs.edit().putString("setdocument", username).commit();
    }

    public String getdocument() {
        String username = prefs.getString("setdocument", "");
        return username;
    }

    public void setdocumentdata(String username) {
        prefs.edit().putString("setdocumentdata", username).commit();
    }

    public String getdocumentdata() {
        String username = prefs.getString("setdocumentdata", "");
        return username;
    }
